const VER_DATA = "0.2.3"; // バージョン更新（全プレイヤーキャラクターへ6ステージの柔軟なマッピング枠『stages』を完全統合）
...
const characters = [
    ...
    },
    {
        ...
        // 椎名ルートの1〜6ステージの枠（ステージ1: eiji, ステージ2: kagami）
        stages: ['eiji', 'kagami', 'shiina', 'jingu', 'godai', 'final']
    },
    {
        id: 'hiragi',
        name: '柊 千華',
