...
scenarios.mamoru = {
    'opening': [
        ...
        { bg: 'meeting.png', place: 'Hospital', time: '2025.04', character: 'nurse.png', spriteIndex: 4, speaker: '看護師', text: '先生、先生？', delay: 30, bgm: 'relax' },
        { bg: 'meeting.png', character: 'shiina.png', spriteIndex: 5, speaker: '護', text: 'やめろ！', effect: 'shake' },
        { bg: 'meeting.png', character: 'nurse.png', spriteIndex: 2, speaker: '看護師', text: 'えっ？　ご面会、お止めしますか？' },
        { bg: 'meeting.png', character: 'shiina.png', spriteIndex: 8, speaker: '護', text: '桧山さん・・・ここは' },
        { bg: 'meeting.png', character: 'nurse.png', spriteIndex: 4, speaker: '桧山', text: '先生、ひょっとして居眠りしてました？' },
        { bg: 'meeting.png', character: 'nurse.png', spriteIndex: 5, speaker: '桧山', text: '働きすぎには注意しないと駄目ですよ' },
        { bg: 'meeting.png', character: 'shiina.png', spriteIndex: 2, speaker: '護', text: 'はは・・・そのようだね' },
        { bg: 'meeting.png', character: 'nurse.png', spriteIndex: 0, speaker: '桧山', text: 'じゃあ面会の人、入れますね' },
        { bg: 'meeting.png', character: 'nurse.png', spriteIndex: 0, effect: 'slideOutLeft', text: '' },
        { bg: 'meeting.png', character: 'kagami.png', spriteIndex: 0, speaker: '各務', text: '失礼する。生きながら心臓を取られた気分はどうだ？' },
        { bg: 'meeting.png', character: 'shiina.png', spriteIndex: 9, speaker: '護', text: 'どうしてそれを!?' },
        { bg: 'meeting.png', character: 'kagami.png', spriteIndex: 9, speaker: '各務', text: '今から１年後に君の解剖記録を読んだからな' },
        ...
        { bg: 'meeting.png', character: 'kagami.png', spriteIndex: 0, speaker: '各務', text: '異世界保険組合。散らばる世界の均衡を保つ仕事だ' },
        { bg: 'meeting.png', character: 'shiina.png', spriteIndex: 10, speaker: '護', text: '異世界保険組合・・・なるほど' },
        { bg: 'meeting.png', character: 'kagami.png', spriteIndex: 6, speaker: '各務', text: '驚かないのだな' },
        { bg: 'meeting.png', character: 'shiina.png', spriteIndex: 0, speaker: '護', text: '実家が特殊ですから、非日常には慣れてるんです' },
        { bg: 'meeting.png', character: 'shiina.png', spriteIndex: 1, speaker: '護', text: 'それで、あなたは何のために僕のところへ？' },
        { bg: 'meeting.png', character: 'kagami.png', spriteIndex: 0, speaker: '各務', text: '単刀直入に言う。君に椎名家を継いでほしい' },
        { bg: 'meeting.png', character: 'shiina.png', spriteIndex: 7, speaker: '護', text: 'あなた、椎名の回し者ですか？' },
        { bg: 'meeting.png', character: 'shiina.png', spriteIndex: 3, speaker: '護', text: '僕に幻覚をみせ、家を継がせようと？' },
        { bg: 'meeting.png', character: 'kagami.png', spriteIndex: 9, speaker: '各務', text: '信じる信じないは勝手だがね' },
        { bg: 'meeting.png', character: 'kagami.png', spriteIndex: 0, speaker: '各務', text: 'このまま１年後を迎えれば、死は確実に訪れるぞ' },
        { bg: 'meeting.png', character: 'shiina.png', spriteIndex: 4, speaker: '護', text: 'はあ・・・参ったな' },
        { bg: 'meeting.png', character: 'kagami.png', spriteIndex: 2, speaker: '各務', text: 'どうした？' },
        { bg: 'meeting.png', character: 'shiina.png', spriteIndex: 4, speaker: '護', text: '家督は既に弟に譲ってしまったんですよ' },
        { bg: 'meeting.png', effect: 'whiteout', text: '' }
    ],
    'kagami_arrival': [
    ...
    2: {
        ...
        adv: [
            ...
            { bg: 'citypanic.png', character: 'shiina.png', spriteIndex: 1, speaker: '護', text: 'よかった。じゃあ各務さんにお任せすれば・・・' },
            { bg: 'citypanic.png', character: 'kagami.png', spriteIndex: 9, speaker: '各務', text: 'スイッチはな、母艦の中にあるんだ' },
        ...
        event_adv: [
            ...
            { bg: 'cityboss.png', character: 'kagami.png', spriteIndex: 13, speaker: '各務', text: '母艦の弾幕は半端ないぞ、椎名くん' },
        ...
        post_stg: [ 
            { bg: 'breakufo2.png', character: 'shiina.png', spriteIndex: 9, speaker: '護', text: 'やった・・・のか？　僕が？', delay: 60, bgm: 'relax' },
            { bg: 'breakufo2.png', character: 'kagami.png', spriteIndex: 6, speaker: '各務', text: 'ああ、やり過ぎたくらいだ' },
            { bg: 'breakufo2.png', character: 'tadashige.png', spriteIndex: 4, speaker: '忠重', text: '護。後始末のコストも考えて動いてもらわねば困るぞ' },
            { bg: 'breakufo2.png', character: 'shiina.png', spriteIndex: 4, speaker: '護', text: 'ご、ごめんなさい、父さん', effect: 'shake' },
            { bg: 'breakufo2.png', character: 'tadashige.png', spriteIndex: 8, speaker: '忠重', text: 'とはいえ、今回はよしとするかな' },
            ...
            { bg: 'breakufo2.png', character: 'tadashige.png', spriteIndex: 2, speaker: '忠重', text: 'これから忙しくなるぞ。ははははっ' },
            { bg: 'breakufo2.png', character: 'kagami.png', spriteIndex: 9, speaker: '各務', text: 'なんか・・・すまない' },
            { bg: 'breakufo2.png', character: 'shiina.png', spriteIndex: 1, speaker: '護', text: '良いんです。僕が自分で選んだ・・・いや' },
            { bg: 'breakufo2.png', character: 'shiina.png', spriteIndex: 10, speaker: '護', text: '自分で『選び直した』道ですから' },
            { bg: 'breakufo2.png', character: 'kagami.png', spriteIndex: 1, speaker: '各務', text: '潔い男だな、君は' },
            { bg: 'breakufo2.png', character: 'shiina.png', spriteIndex: 0, speaker: '護', text: 'ところで各務さん。これで僕は一年後、死なずに済むのでしょうか' },
            { bg: 'breakufo2.png', character: 'kagami.png', spriteIndex: 0, speaker: '各務', text: 'いや。もちろん、力を得た上で元凶となる相手を倒さなくてはならない' },
            { bg: 'breakufo2.png', character: 'shiina.png', spriteIndex: 12, speaker: '護', text: '元凶、ですか・・・？' },
            { bg: 'breakufo2.png', character: 'kagami.png', spriteIndex: 9, speaker: '各務', text: 'すまない、規定上ここから先の介入はできないんだ' },
            { bg: 'breakufo2.png', character: 'shiina.png', spriteIndex: 10, speaker: '護', text: '自分で探すしかない、か' }
        ]
    },
