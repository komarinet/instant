...
const MainController = {
    ...
    showModal(isWin) {
        ...
        document.getElementById('modal-desc').innerText = isWin ? "Moving to next sector." : "Reboot required.";
